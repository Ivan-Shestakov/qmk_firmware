...
All layers are available from both hands

Initially, a 5x6 board was constructed and tested.
When layers became second nature and I discovered homerow mods - second board was built as 4x5.
It serves as office and travel board. Same firmware can be flashed on both.

`qmk flash -kb handwired/dactyl_manuform/5x6 -km colemak-dreymar`
